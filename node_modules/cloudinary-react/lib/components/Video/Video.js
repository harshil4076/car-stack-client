  ...
  function Video() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getVideoTagProps", function () {
      var _this$getMergedProps = _this.getMergedProps(),
          ...
          _this$getMergedProps$ = _this$getMergedProps.sourceTypes,
          sourceTypes = _this$getMergedProps$ === void 0 ? _cloudinaryCore.Cloudinary.DEFAULT_VIDEO_PARAMS.source_types : _this$getMergedProps$,
          _this$getMergedProps$2 = _this$getMergedProps.sourceTransformation,
          sourceTransformation = _this$getMergedProps$2 === void 0 ? {} : _this$getMergedProps$2,
